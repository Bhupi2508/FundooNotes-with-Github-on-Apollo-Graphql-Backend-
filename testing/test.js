    ...
    it('removeCollaborators APIs', done => {
        request('http://localhost:4000')
            ...
            .end((err, res) => {
                ...
                //otherwise return success 
                expect(JSON.parse(res.text).data.removeCollaboration.message).to.deep.equal("This collaborator is not present")
                done();
    ...
    it('deleteWatch In Git Repo APIs', done => {
        request('http://localhost:4000')
            ...
            .end((err, res) => {
                ...
                //otherwise return success 
                expect(JSON.parse(res.text).data.deleteWatchInGitRepo.message).to.deep.equal("Watch Remove successfully from Git Repository")
                done();
    ...
    it('Delete Git Branch Repository APIs', done => {
        ...
        request('http://localhost:4000')
            ...
            .end((err, res) => {
                ...
                //otherwise return success 
                expect(JSON.parse(res.text).data.deleteGitBranch.message).to.deep.equal("git branch delete Successfully")
                done();
